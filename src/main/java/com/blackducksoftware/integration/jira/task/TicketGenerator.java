...
import com.blackducksoftware.integration.jira.notification.NotificationContentItem;
import com.blackducksoftware.integration.jira.notification.NotificationEvent;
import com.blackducksoftware.integration.jira.notification.NotificationResults;
import com.blackducksoftware.integration.jira.notification.NotificationService;
import com.blackducksoftware.integration.jira.notification.PolicyNotificationFilter;
...
public class TicketGenerator {
    ...
    public TicketGenerator(final HubServicesFactory hubServicesFactory, final JiraServices jiraServices, final JiraContext jiraContext, final JiraSettingsService jiraSettingsService, final TicketInfoFromSetup ticketInfoFromSetup,
        ...
        this.notificationService = new NotificationService(hubServicesFactory.createHubService());
